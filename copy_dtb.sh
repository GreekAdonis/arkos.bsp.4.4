...
CONSOLE_DIR="/mnt/d/github/arkos4clone/consoles"
...
declare -A DTB_MAP=(
    ...
    ["rk3326-r36max-linux"]="r36max"
    ["rk3326-r36max-without-amp-linux"]="r36max noamp"
    ...
    ["rk3326-r36s-panel4-linux"]="origin panel4"
    ...
    ["rk3326-r36s-type4-linux"]="clone type4"
    ["rk3326-r36s-type5-linux"]="clone type5"
    ["rk3326-r36s-v21-linux"]="v21 panel4 rumble test"
    ["rk3326-r36s-v22-linux"]="v22 panel4"
    ["rk3326-r36s-v30-linux"]="v30 panel4"
...
for dtb_name in "${!DTB_MAP[@]}"; do
    folder="${DTB_MAP[$dtb_name]}"
    src="$DTB_DIR/${dtb_name}.dtb"
    ...
    cp "$src" "$dst" && echo "[OK] $src -> $dst" && ((success++)) || ((fail++))
done
