...
/* kernel 4.4 uses cfg80211_rx_assoc_resp instead of cfg80211_send_rx_assoc */
...
/* cfg80211_send_disassoc doesn't exist in kernel 4.4, use cfg80211_tx_mlme_mgmt instead */
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 6, 0))
#define cfg80211_send_disassoc(dev, buf, len) cfg80211_tx_mlme_mgmt(dev, buf, len)
#endif
